...
const values = [
  {
    ...
    title: "Direct Trade Origins" ,
    description: 
    "We partner directly with small farms in Ethiopia, Colombia, Guatemala, and Indonesia. Every Bag is fully traceable to the farm it comes from" ,
  },  
  {
    icon: "☕",
    title: "Small-Batch Roasting" ,
    description: 
    "Our master roaster profiles every bean to unlock its peak flavor. We reast in 25lb barches for consistency and freshness you can taste." ,
  },  
  {
    icon: "🚚",
    title: "Roast-To-Order-Shipping" ,
    description: 
    "We don't pre-roast and shelve. Your beans are roasted after you order and shipped within 1-2 days. Free delviery on orders over $50." ,
        ...
        <div className="about-content">
            ...
            <div className="about-story-grid">
                <ScrollReveal animation="fadeLeft" className="about-story-text">
                    ...
                    <p className="about-body lead--light">
                        Every week, our roastmaster cups dozens of samples to select only the lots that meets our stanards. Whether you prefer a bright, fruity Ethiopian Yirgacheffe or a deep, chocolately Colombian Supremo, we roast each batch to order so it arrives at peak freshness. 
                    </p>
                </ScrollReveal>
                
                <ScrollReveal animation="fadeRight" delay={0.2} className="about-story-image">
                    <div className="about-image-stack">
                        <img
                            src={coffeePlants}
                    ...
                    <StaggerItem key={v.title} animation="fadeUp">
                        <Card glass className="about-value-card">
                            <CardHeader>
                                ...
                                <h3 className="text-lg font-bold test-(--cream)">{v.title}</h3>
                            </CardHeader>
